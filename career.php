...
<body>
    ...
    <div class="form-container">
        <form action="php/career_store.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <h2 class="heading">Job Application</h2>11
                ...
                <div class="controls">
                    <textarea id="cover_letter" class="floatLabel" name="cover_letter"></textarea>
